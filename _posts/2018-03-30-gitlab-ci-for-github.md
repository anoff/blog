...
![Create a new project in Gitlab](/img/assets/gitlab-ci/new_project.png)

![Create a new project in Gitlab](/img/assets/gitlab-ci/new_project_github.png)
...
![Create project from GitHub source](/img/assets/gitlab-ci/gitlab_projects.png)
...
![Webhook in GitHub](/img/assets/gitlab-ci/github_hook.png)
![GitLab project mirroring settings](/img/assets/gitlab-ci/gitlab_mirror.png)
...
![GitHub pending build](/img/assets/gitlab-ci/github_build_status_pending.png)
> GitHub commit view with a pending GitLab pipeline

![GitLab pipeline overview](/img/assets/gitlab-ci/gitlab_pipeline.png)
>GitLab view of the pipeline in process

![Successful build on GitHub](/img/assets/gitlab-ci/github_build_status.png)
...
![GitLab permission settings](/img/assets/gitlab-ci/gitlab_permissions.png)
...
![GitLab project showing link to GitHub](/img/assets/gitlab-ci/ci_dummy.png)
