...
share-img: ./img/assets/book-intro/title.png
image: ./img/assets/book-intro/logo.png
---
...
`by Ashlee Vance` <img src="{{ site.baseurl }}/img/assets/books-intro/musk.jpg" />
...
`by Jason Fried & David Heinemeier Hansson` <img src="{{ site.baseurl }}/img/assets/books-intro/rework.jpg" class="left"/>
...
`by Duncan Clark` <img src="{{ site.baseurl }}/img/assets/books-intro/alibaba.jpg" />
...
`by Satya Nadella` <img src="{{ site.baseurl }}/img/assets/books-intro/nadella.jpg" class="left"/>
...
`by Cathy O'Neil` <img src="{{ site.baseurl }}/img/assets/books-intro/math.jpg" />
...
`by Gene Kim, Kevin Behr & George Spafford` <img src="{{ site.baseurl }}/img/assets/books-intro/phoenix.jpg" class="left"/>
