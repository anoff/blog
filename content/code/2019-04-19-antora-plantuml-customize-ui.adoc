...
image::screenshot.png[Screenshot of the gitarc.xyz page]
...
image::ui-style.png[Dan Allen on customizing the UI]
...
image::navdrop.gif[component navigation dropdown]
