...
This means that you will have to install the associated tool on your machine to be able to use these formats. ⸺ [the Hugo docs](//gohugo.io/content-management/formats/#additional-formats-through-external-helpers)

So all there is to do, is to install the [Asciidoctor toolchain](//asciidoctor.org/) on the machine you are running hugo - or CI server respectively.
...
![Broken lists in HTML](/assets/hugo-asciidoc/list-breaks.png)

I stumbled upon the GitHub issue [hugo#1437](//github.com/gohugoio/hugo/issues/1437#issuecomment-462270099) that led me to the first hack inspired by [David Gauer](//ratfactor.com/hugo-adoc-html5s/).
...
This is caused by the use of `asciidoctor-html5s` and [expected behavior](//github.com/jirutka/asciidoctor-html5s/issues/11) by the author.

**Semantic HTML5 Asciidoctor admonitions with HTML source**

![Unstyled admonitions](/assets/hugo-asciidoc/admonitions.png)
...
Instead I applied the DOM layout and CSS style that the [Antora UI project](//gitlab.com/antora/antora-ui-default/) uses for admonitions.
...
![Final admonitions](/assets/hugo-asciidoc/antora-admonitions.png)
