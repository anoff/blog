...
\begin{center}
  \includegraphics[height=40pt, width=0.9\textwidth, keepaspectratio]{diagrams/dist/arrows.pdf}

  \includegraphics[height=40pt, width=0.9\textwidth, keepaspectratio]{diagrams/dist/arrows-2.pdf}
\end{center}
}
...
\begin{center}
  \includegraphics[width=0.5\textwidth]{diagrams/dist/icons.pdf}
  \includegraphics[width=0.3\textwidth]{diagrams/dist/icons-transparent.pdf}
\end{center}
...
\begin{center}
  \includegraphics[height=80pt, width=0.9\textwidth, keepaspectratio]{diagrams/dist/icons-sprite.pdf}
\end{center}
